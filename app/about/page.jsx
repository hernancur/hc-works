      ...
      <div className="relative max-w-5xl mx-auto px-8">
        ...
        <div className="mt-10">
          ...
          <p className="my-10">
            ...
            peers and introducing new people to web development by teaching them
            what I have learned and how they can apply their skills to create
            amazing things. I give free courses for beginners.
          </p>
          ...
          <p>
            ...
            better experiences. In the future, I hope to keep pushing to use my
            skills to make real impact. I'm excited to see where this journey
            takes me, and I look forward to sharing my experiences and insights
            along the way. Till then keep iterating!
          </p>
